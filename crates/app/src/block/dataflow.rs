...
fn resolve_external_inputs(
    inputs: &HashSet<dac26_core::types::SignalNode>,
    internal_outputs: &HashSet<dac26_core::types::SignalNode>,
    entry_inputs: &HashMap<dac26_core::types::SignalNode, HashSet<dac26_core::types::SignalNode>>,
) -> HashSet<dac26_core::types::SignalNode> {
...
fn expand_input(
    input: &dac26_core::types::SignalNode,
    internal_outputs: &HashSet<dac26_core::types::SignalNode>,
    entry_inputs: &HashMap<dac26_core::types::SignalNode, HashSet<dac26_core::types::SignalNode>>,
    visiting: &mut HashSet<dac26_core::types::SignalNode>,
    resolved: &mut HashSet<dac26_core::types::SignalNode>,
) {
...
fn locate_from_node(node: RefNode) -> dac26_core::types::SignalLocate {
    unwrap_locate!(node)
        .map(|loc| dac26_core::types::SignalLocate {
            offset: loc.offset,
            line: usize::try_from(loc.line).unwrap_or(0),
            len: loc.len,
        })
        .unwrap_or_else(|| dac26_core::types::SignalLocate::unknown(0))
}

fn identifier_signal_node(
    syntax_tree: &sv_parser::SyntaxTree,
    node: RefNode,
) -> dac26_core::types::SignalNode {
    let name = identifier_text(syntax_tree, node.clone());
    dac26_core::types::SignalNode::variable(name, locate_from_node(node))
}
...
fn hierarchical_variable_identifier_signal_node(
    ...
    dac26_core::types::SignalNode::variable(
...
fn collect_statement_or_null_dataflow(
    ...
    conditions: &mut Vec<HashSet<dac26_core::types::SignalNode>>,
...
fn collect_block_item_declaration_dataflow(
    ...
    conditions: &[HashSet<dac26_core::types::SignalNode>],
    dataflow: &mut Vec<DataflowEntry>,
) {
...
fn collect_conditional_dataflow(
    ...
    let mut prior_else_if_predicates: Vec<HashSet<dac26_core::types::SignalNode>> = Vec::new();
...
fn collect_case_item_dataflow(
    ...
    selector: &HashSet<dac26_core::types::SignalNode>,
    conditions: &mut Vec<HashSet<dac26_core::types::SignalNode>>,
    dataflow: &mut Vec<DataflowEntry>,
) {
    match item {
...
fn extend_condition_inputs(
    inputs: &mut HashSet<dac26_core::types::SignalNode>,
    conditions: &[HashSet<dac26_core::types::SignalNode>],
) {
...
fn variable_lvalue_nodes(
    syntax_tree: &sv_parser::SyntaxTree,
    lvalue: &sv_parser::VariableLvalue,
) -> Vec<dac26_core::types::SignalNode> {
    match lvalue {
...
fn to_entry(outputs: Vec<String>, inputs: HashSet<String>) -> DataflowEntry {
    DataflowEntry {
        output: outputs
            .into_iter()
            .map(dac26_core::types::SignalNode::named)
            .collect(),
        inputs: inputs
            .into_iter()
            .map(dac26_core::types::SignalNode::named)
...
) -> HashMap<dac26_core::types::SignalNode, HashSet<dac26_core::types::SignalNode>> {
        ...
        match child {
            ...
            RefNode::Number(number) => {
                let text = syntax_tree
                    ...
                    .unwrap_or_default()
                    .to_string();
                names.insert(dac26_core::types::SignalNode::literal_with_locate(
                    text,
